<div class="flex flex-col text-center">
  ...
  <input class="my-4 mx-auto sm:h-20 max-w-full sm:w-96 text-2xl border border-violet-blue-2 rounded-2xl text-center" type="text" placeholder="E-Mail">

  <button class="my-4 mx-auto h-14 w-52 text-2xl rounded-xl bg-violet-blue-2 text-white text-2xl font-semibold">Submit</button>
</div>
