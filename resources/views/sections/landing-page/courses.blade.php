<div>
    <div class="mx-auto max-w-[27rem] text-center">
        <h2 class="text-navy-blue text-4xl font-extrabold">Our Popular Courses</h2>
        <p class="text-outer-space text-sm font-normal">Lorem ipsum dolor sit amet, in sed integer. Scelerisque nam evget imperdiet accumsan, ipsum  turpis cursus. In elit amet, tortor nunc.</p>
    </div>

    <div class="flex flex-row text-outer-space mx-auto max-w-[60rem] justify-between">
